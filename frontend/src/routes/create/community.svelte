<script lang="ts">
	...
	import type { Props_CreateCommunityData } from '../../services/types';
	import { isImage, minLenValidator, validInputs } from '../../utils/inputValidators';
	...
	function handleCreateCommunity() {
		if (validInputs(_thisForm)) {
			createCommunity(data).then((res: any) => goto('/communities/' + res.id));
		}
	}
